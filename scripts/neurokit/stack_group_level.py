...
if discovery:
    ...
    log_dir = join(cuestudy_dir, "scripts", "logcenter")
# glob files
save_dir = join(cuestudy_dir, 'data', 'physio', '02_preproc-physio')
tonic_flist = glob.glob(join(cuestudy_dir, 'data', 'physio', '02_preproc-physio', '*', '*', 
...
phasic_flist = glob.glob(join(cuestudy_dir, 'data', 'physio', '02_preproc-physio', '*', '*', 
