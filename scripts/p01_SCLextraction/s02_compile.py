...
also plot average signals for QC purposes
"""
...
#                               glob files
# ----------------------------------------------------------------------
main_dir = '/Volumes/spacetop_projects_social' # main_dir = '/Users/h/Dropbox/projects_dropbox/social_influence_analysis'
