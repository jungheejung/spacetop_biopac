...
save_dir = '/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/physio/nobaseline/glm_singletrial'

scl_dir = '/Volumes/spacetop_projects_cue/analysis/physio/nobaseline/physio01_SCL' 
save_dir = '/Volumes/spacetop_projects_cue/analysis/physio/nobaseline/glm_singletrial'                
...
for ind, scl_fpath in enumerate(sorted(filtered_list)):
    ...
    cue_stim_cond = condition_name_list
#     #['high_cue', 'low_cue','high_stim-high_cue',
#  'high_stim-low_cue',
#  'med_stim-high_cue',
#  'med_stim-low_cue',
#  'low_stim-high_cue',
#  'low_stim-low_cue']
    ...
    for ind in range(24):
        betadf.at[ind, cue_stim_cond[ind]] = reg.coef_[0][ind]
